    ...
    newSigner(hsmSignerOptions) {
        ...
        return {
            signer: (digest) => {
                ...
                const compactSignature = pkcs11.C_Sign(session, Buffer.from(digest), 
                ...
                Buffer.alloc(p256_1.p256.CURVE.nByteLength * 2));
                const signature = p256_1.p256.Signature.fromCompact(compactSignature).normalizeS().toDERRawBytes();
